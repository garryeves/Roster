...
public class clients: NSObject, Identifiable
{
    ...
    public init(query: String, teamID: Int64, isActive: Bool)
    {
        ...
        for myItem in returnArray
        {
            ...
            if myItem.clientName == nil
            {
                tempClientName = ""
            }
            else
            {
                tempClientName = myItem.clientName!
            }
...
public class client: NSObject, Identifiable
{
    public let id = UUID()
    ...
    {
        return projects(clientID: myClientID, teamID: myTeamID, isActive: isActive, type: "").projects
    }
    ...
    public func delete()
    {
        if currentUser.checkWritePermission(pmRoleType) || currentUser.checkWritePermission(salesRoleType)
        {
            ...
            for myProject in projects(clientID: myClientID, teamID: myTeamID, isActive: true).projects
            {
