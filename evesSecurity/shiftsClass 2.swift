...
public struct mergedShiftList: Identifiable
{
    public let id = UUID()
    var contract: String!
    var projectID: Int64!
...
public class rosterPerson: NSObject, Identifiable
{
    public let id = UUID()
...
public class shifts: NSObject, Identifiable
{
    public let id = UUID()
    ...
    public init(teamID: Int64, WEDate: Date, type: String)
    {
        super.init()
        myTeamID = teamID
        ...
        for item in (currentUser.currentTeam?.shifts!)!
        {
    ...
    public init(teamID: Int64)
    {
        ...
        for myItem in (currentUser.currentTeam?.shifts!)!
        {
            let myObject = shift(shiftID: myItem.shiftID,
                                 projectID: myItem.projectID,
                                 personID: myItem.personID,
    ...
    public init(teamID: Int64, WEDate: Date, includeEvents: Bool = false)
    {
        super.init()
        myTeamID = teamID
        myWeeklyShifts.removeAll()
...
//                if (item.weekEndDate! >= startDate) && (item.weekEndDate! <= endDate) && (item.type! != eventShiftType)
    ...
    public init(teamID: Int64, month: Int, year: Int)
    {
        super.init()
        myTeamID = teamID
        myWeeklyShifts.removeAll()
    ...
    public init(projectID: Int64, startDate: Date, endDate: Date, teamID: Int64)
    {
        super.init()
        myTeamID = teamID
        myWeeklyShifts.removeAll()
    ...
    public init(projectID: Int64, month: String, year: String, teamID: Int64)
    {
        super.init()
        myTeamID = teamID
        myWeeklyShifts.removeAll()
    ...
    public init(clientID: Int64, month: String, year: String, teamID: Int64)
    {
        super.init()
        myTeamID = teamID
        myWeeklyShifts.removeAll()
        ...
        for projectItem in projects(clientID: clientID, teamID: teamID, isActive: false).projects
        {
            for item in (currentUser.currentTeam?.shifts!)!
            {
    ...
    public init(personID: Int64, searchFrom: Date, searchTo: Date, teamID: Int64, type: String)
    {
        super.init()
        myTeamID = teamID
        myWeeklyShifts.removeAll()
    ...
    public init(projectID: Int64, searchFrom: Date, searchTo: Date, teamID: Int64, type: String)
    {
        super.init()
        myTeamID = teamID
        myWeeklyShifts.removeAll()
    ...
    public init(query: String, teamID: Int64)
    {
        super.init()
        myTeamID = teamID
        myShifts.removeAll()
    ...
    public init(invoiceID: Int64, teamID: Int64)
    {
        super.init()
        myTeamID = teamID
...
public class shift: NSObject, Identifiable
{
    public let id = UUID()
...
extension alerts
{
    public func shiftAlerts(_ teamID: Int64)
    {
        ...
        if (currentUser.currentTeam!.shifts?.count)! > 0
        {
...
extension report
{
    ...
    public func reportContractForYear(year: String)
    {
        ...
        for myClient in clients(teamID: currentUser.currentTeam!.teamID, isActive: true).clients
        {
            ...
            for myProject in myClient.projectList(true)
            {
