...
public class eventTemplates: NSObject, Identifiable
{
    ...
    {
        if currentUser.currentTeam?.eventTemplates == nil
        {
            currentUser.currentTeam?.eventTemplates = myCloudDB.getEventTemplates(teamID: teamID)
        }
        
        var workingArray: [EventTemplate] = Array()
        
        for item in (currentUser.currentTeam?.eventTemplates)!
        {
...
public class eventTemplate: NSObject, Identifiable
{
    ...
    public func save()
    {
        ...
        {
            let temp = EventTemplate(dateModifier: myDateModifier, endTime: myEndTime, eventID: myEventID, eventName: myEventName, numRequired: myNumRequired, role: myRole, startTime: myStartTime, teamID: myTeamID)
